...
function lire_articles($offset, $limite){
	...
	// var_dump ($pdo);
	try {
		$query= "SELECT  post_ID, post_title,  DATE_FORMAT(post_date,'%Y.%c.%d à %H:%i') AS post_date, post_img_url, LEFT(post_content, " . POST_TR . ") AS post_content, display_name, cat_descr
